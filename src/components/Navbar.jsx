...
const Navbar = () => {
  return (
    <div className="flex justify-between  h-[50px] p-2 text-white">
      <div className=" flex items-center justify-center">
        ...
        <img src="/images/logo.png" className="w-[90px] object-cover" alt="" />
      </div>
      <div className="flex items-center justify-center gap-2">
        <img src="https://img.icons8.com/color/48/businessman.png" className="size-[25px] rounded-full bg-[#010027]" alt="" />
